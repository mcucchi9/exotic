...
force_intensity_linear_coefficient = float(sys.argv[1])
deactivation_time = int(sys.argv[2])
sim_num = int(sys.argv[3])

forcing_str = 'LF_8_{}_0_{}'.format(force_intensity_linear_coefficient, deactivation_time)
