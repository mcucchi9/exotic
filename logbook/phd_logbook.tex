...
\begin{figure}[!ht]
	...
	\end{subfigure}%
	\begin{subfigure}[b]{0.48\textwidth}
		\includegraphics[width=1\linewidth]{fig/pred_cdf_position_bin_00q_10q_LF_8_002_0_100.png}
		\caption{Linear Forcing - $(F_0=8, C=0.02, t_f=100)$}
	...
	\end{subfigure}%
	\begin{subfigure}[b]{0.48\textwidth}
		\includegraphics[width=1\linewidth]{fig/pred_pdf_position_bin_00q_10q_LF_8_002_0_100.png}
		\caption{Linear Forcing - $(F_0=8, C=0.02, t_f=100)$}
